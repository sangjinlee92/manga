    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 61; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-60.html;
        document.getElementById('next-chapter').href = capitulo-62.html;
    });
