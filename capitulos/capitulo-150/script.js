    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 150; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-149.html;
        document.getElementById('next-chapter').href = capitulo-151.html;
    });
