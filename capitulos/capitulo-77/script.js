    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 77; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-76.html;
        document.getElementById('next-chapter').href = capitulo-78.html;
    });
