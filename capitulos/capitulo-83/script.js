    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 83; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-82.html;
        document.getElementById('next-chapter').href = capitulo-84.html;
    });
