    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 96; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-95.html;
        document.getElementById('next-chapter').href = capitulo-97.html;
    });
