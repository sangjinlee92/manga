    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 64; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-63.html;
        document.getElementById('next-chapter').href = capitulo-65.html;
    });
