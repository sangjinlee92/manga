    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 62; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-61.html;
        document.getElementById('next-chapter').href = capitulo-63.html;
    });
