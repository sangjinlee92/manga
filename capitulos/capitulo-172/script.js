    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 172; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-171.html;
        document.getElementById('next-chapter').href = capitulo-173.html;
    });
