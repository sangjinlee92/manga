    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 162; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-161.html;
        document.getElementById('next-chapter').href = capitulo-163.html;
    });
