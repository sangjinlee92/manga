    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 82; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-81.html;
        document.getElementById('next-chapter').href = capitulo-83.html;
    });
