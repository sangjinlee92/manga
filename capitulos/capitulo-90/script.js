    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 90; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-89.html;
        document.getElementById('next-chapter').href = capitulo-91.html;
    });
