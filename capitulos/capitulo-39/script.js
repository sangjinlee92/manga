    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 39; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-38.html;
        document.getElementById('next-chapter').href = capitulo-40.html;
    });
