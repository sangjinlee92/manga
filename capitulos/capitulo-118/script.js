    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 118; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-117.html;
        document.getElementById('next-chapter').href = capitulo-119.html;
    });
