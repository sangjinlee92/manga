    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 80; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-79.html;
        document.getElementById('next-chapter').href = capitulo-81.html;
    });
