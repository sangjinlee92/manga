    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 94; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-93.html;
        document.getElementById('next-chapter').href = capitulo-95.html;
    });
