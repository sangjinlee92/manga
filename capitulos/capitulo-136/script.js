    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 136; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-135.html;
        document.getElementById('next-chapter').href = capitulo-137.html;
    });
