    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 173; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-172.html;
        document.getElementById('next-chapter').href = capitulo-174.html;
    });
