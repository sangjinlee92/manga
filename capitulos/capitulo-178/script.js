    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 178; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-177.html;
        document.getElementById('next-chapter').href = capitulo-179.html;
    });
