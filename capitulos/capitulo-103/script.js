    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 103; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-102.html;
        document.getElementById('next-chapter').href = capitulo-104.html;
    });
