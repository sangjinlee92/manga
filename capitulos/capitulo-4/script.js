    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 4; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-3.html;
        document.getElementById('next-chapter').href = capitulo-5.html;
    });
