    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 157; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-156.html;
        document.getElementById('next-chapter').href = capitulo-158.html;
    });
