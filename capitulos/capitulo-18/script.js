    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 18; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-17.html;
        document.getElementById('next-chapter').href = capitulo-19.html;
    });
