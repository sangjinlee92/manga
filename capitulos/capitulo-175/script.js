    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 175; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-174.html;
        document.getElementById('next-chapter').href = capitulo-176.html;
    });
