    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 137; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-136.html;
        document.getElementById('next-chapter').href = capitulo-138.html;
    });
