    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 11; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-10.html;
        document.getElementById('next-chapter').href = capitulo-12.html;
    });
