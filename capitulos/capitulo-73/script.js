    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 73; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-72.html;
        document.getElementById('next-chapter').href = capitulo-74.html;
    });
