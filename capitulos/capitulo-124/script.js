    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 124; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-123.html;
        document.getElementById('next-chapter').href = capitulo-125.html;
    });
