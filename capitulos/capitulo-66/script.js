    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 66; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-65.html;
        document.getElementById('next-chapter').href = capitulo-67.html;
    });
