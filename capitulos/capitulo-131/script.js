    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 131; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-130.html;
        document.getElementById('next-chapter').href = capitulo-132.html;
    });
