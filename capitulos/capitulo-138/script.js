    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 138; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-137.html;
        document.getElementById('next-chapter').href = capitulo-139.html;
    });
