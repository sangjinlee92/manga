    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 28; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-27.html;
        document.getElementById('next-chapter').href = capitulo-29.html;
    });
