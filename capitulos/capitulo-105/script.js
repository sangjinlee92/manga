    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 105; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-104.html;
        document.getElementById('next-chapter').href = capitulo-106.html;
    });
