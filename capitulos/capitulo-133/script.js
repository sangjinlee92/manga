    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 133; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-132.html;
        document.getElementById('next-chapter').href = capitulo-134.html;
    });
