    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 25; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-24.html;
        document.getElementById('next-chapter').href = capitulo-26.html;
    });
