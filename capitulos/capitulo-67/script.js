    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 67; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-66.html;
        document.getElementById('next-chapter').href = capitulo-68.html;
    });
