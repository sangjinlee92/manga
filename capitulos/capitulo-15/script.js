    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 15; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-14.html;
        document.getElementById('next-chapter').href = capitulo-16.html;
    });
