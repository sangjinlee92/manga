    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 36; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-35.html;
        document.getElementById('next-chapter').href = capitulo-37.html;
    });
