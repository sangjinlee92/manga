    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 106; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-105.html;
        document.getElementById('next-chapter').href = capitulo-107.html;
    });
