    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 31; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-30.html;
        document.getElementById('next-chapter').href = capitulo-32.html;
    });
