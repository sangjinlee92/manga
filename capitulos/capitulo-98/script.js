    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 98; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-97.html;
        document.getElementById('next-chapter').href = capitulo-99.html;
    });
