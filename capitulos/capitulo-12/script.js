    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 12; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-11.html;
        document.getElementById('next-chapter').href = capitulo-13.html;
    });
