    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 53; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-52.html;
        document.getElementById('next-chapter').href = capitulo-54.html;
    });
