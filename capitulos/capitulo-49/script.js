    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 49; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-48.html;
        document.getElementById('next-chapter').href = capitulo-50.html;
    });
