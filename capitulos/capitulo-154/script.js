    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 154; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-153.html;
        document.getElementById('next-chapter').href = capitulo-155.html;
    });
