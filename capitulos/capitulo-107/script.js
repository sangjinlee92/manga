    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 107; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-106.html;
        document.getElementById('next-chapter').href = capitulo-108.html;
    });
