    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 166; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-165.html;
        document.getElementById('next-chapter').href = capitulo-167.html;
    });
