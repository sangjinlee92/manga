    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 6; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-5.html;
        document.getElementById('next-chapter').href = capitulo-7.html;
    });
