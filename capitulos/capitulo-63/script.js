    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 63; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-62.html;
        document.getElementById('next-chapter').href = capitulo-64.html;
    });
