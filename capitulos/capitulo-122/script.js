    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 122; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-121.html;
        document.getElementById('next-chapter').href = capitulo-123.html;
    });
