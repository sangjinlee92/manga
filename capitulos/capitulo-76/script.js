    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 76; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-75.html;
        document.getElementById('next-chapter').href = capitulo-77.html;
    });
