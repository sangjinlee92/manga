    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 78; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-77.html;
        document.getElementById('next-chapter').href = capitulo-79.html;
    });
