    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 20; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-19.html;
        document.getElementById('next-chapter').href = capitulo-21.html;
    });
