    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 26; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-25.html;
        document.getElementById('next-chapter').href = capitulo-27.html;
    });
