    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 156; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-155.html;
        document.getElementById('next-chapter').href = capitulo-157.html;
    });
