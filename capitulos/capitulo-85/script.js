    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 85; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-84.html;
        document.getElementById('next-chapter').href = capitulo-86.html;
    });
