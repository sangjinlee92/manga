    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 51; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-50.html;
        document.getElementById('next-chapter').href = capitulo-52.html;
    });
