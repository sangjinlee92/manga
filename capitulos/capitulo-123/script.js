    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 123; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-122.html;
        document.getElementById('next-chapter').href = capitulo-124.html;
    });
