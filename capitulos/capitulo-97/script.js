    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 97; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-96.html;
        document.getElementById('next-chapter').href = capitulo-98.html;
    });
