    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 176; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-175.html;
        document.getElementById('next-chapter').href = capitulo-177.html;
    });
