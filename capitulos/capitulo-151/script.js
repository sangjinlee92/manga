    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 151; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-150.html;
        document.getElementById('next-chapter').href = capitulo-152.html;
    });
