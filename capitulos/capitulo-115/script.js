    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 115; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-114.html;
        document.getElementById('next-chapter').href = capitulo-116.html;
    });
