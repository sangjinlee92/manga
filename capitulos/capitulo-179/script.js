    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 179; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-178.html;
        document.getElementById('next-chapter').href = capitulo-180.html;
    });
