    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 102; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-101.html;
        document.getElementById('next-chapter').href = capitulo-103.html;
    });
