    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 43; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-42.html;
        document.getElementById('next-chapter').href = capitulo-44.html;
    });
