    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 169; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-168.html;
        document.getElementById('next-chapter').href = capitulo-170.html;
    });
