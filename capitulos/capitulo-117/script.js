    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 117; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-116.html;
        document.getElementById('next-chapter').href = capitulo-118.html;
    });
