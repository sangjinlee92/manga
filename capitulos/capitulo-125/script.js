    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 125; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-124.html;
        document.getElementById('next-chapter').href = capitulo-126.html;
    });
