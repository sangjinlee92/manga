    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 170; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-169.html;
        document.getElementById('next-chapter').href = capitulo-171.html;
    });
