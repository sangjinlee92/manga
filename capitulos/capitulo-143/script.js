    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 143; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-142.html;
        document.getElementById('next-chapter').href = capitulo-144.html;
    });
