    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 10; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-9.html;
        document.getElementById('next-chapter').href = capitulo-11.html;
    });
