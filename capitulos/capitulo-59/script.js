    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 59; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-58.html;
        document.getElementById('next-chapter').href = capitulo-60.html;
    });
