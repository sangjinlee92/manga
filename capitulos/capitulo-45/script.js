    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 45; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-44.html;
        document.getElementById('next-chapter').href = capitulo-46.html;
    });
