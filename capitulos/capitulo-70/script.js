    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 70; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-69.html;
        document.getElementById('next-chapter').href = capitulo-71.html;
    });
