    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 88; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-87.html;
        document.getElementById('next-chapter').href = capitulo-89.html;
    });
