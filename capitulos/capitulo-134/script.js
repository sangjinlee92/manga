    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 134; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-133.html;
        document.getElementById('next-chapter').href = capitulo-135.html;
    });
