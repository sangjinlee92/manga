    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 13; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-12.html;
        document.getElementById('next-chapter').href = capitulo-14.html;
    });
