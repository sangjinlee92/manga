    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 101; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-100.html;
        document.getElementById('next-chapter').href = capitulo-102.html;
    });
