    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 52; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-51.html;
        document.getElementById('next-chapter').href = capitulo-53.html;
    });
