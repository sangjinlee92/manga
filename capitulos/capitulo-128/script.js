    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 128; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-127.html;
        document.getElementById('next-chapter').href = capitulo-129.html;
    });
