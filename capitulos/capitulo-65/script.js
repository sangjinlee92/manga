    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 65; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-64.html;
        document.getElementById('next-chapter').href = capitulo-66.html;
    });
