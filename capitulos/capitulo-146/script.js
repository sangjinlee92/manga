    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 146; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-145.html;
        document.getElementById('next-chapter').href = capitulo-147.html;
    });
