    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 71; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-70.html;
        document.getElementById('next-chapter').href = capitulo-72.html;
    });
