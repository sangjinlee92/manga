    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 95; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-94.html;
        document.getElementById('next-chapter').href = capitulo-96.html;
    });
