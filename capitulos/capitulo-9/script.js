    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 9; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-8.html;
        document.getElementById('next-chapter').href = capitulo-10.html;
    });
