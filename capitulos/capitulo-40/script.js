    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 40; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-39.html;
        document.getElementById('next-chapter').href = capitulo-41.html;
    });
