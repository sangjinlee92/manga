    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 75; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-74.html;
        document.getElementById('next-chapter').href = capitulo-76.html;
    });
