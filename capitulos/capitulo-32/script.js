    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 32; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-31.html;
        document.getElementById('next-chapter').href = capitulo-33.html;
    });
