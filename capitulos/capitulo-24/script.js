    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 24; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-23.html;
        document.getElementById('next-chapter').href = capitulo-25.html;
    });
