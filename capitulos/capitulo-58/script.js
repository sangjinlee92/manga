    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 58; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-57.html;
        document.getElementById('next-chapter').href = capitulo-59.html;
    });
