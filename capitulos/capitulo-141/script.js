    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 141; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-140.html;
        document.getElementById('next-chapter').href = capitulo-142.html;
    });
