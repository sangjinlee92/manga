    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 144; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-143.html;
        document.getElementById('next-chapter').href = capitulo-145.html;
    });
