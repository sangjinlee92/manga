    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 171; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-170.html;
        document.getElementById('next-chapter').href = capitulo-172.html;
    });
