    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 79; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-78.html;
        document.getElementById('next-chapter').href = capitulo-80.html;
    });
