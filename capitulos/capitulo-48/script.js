    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 48; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-47.html;
        document.getElementById('next-chapter').href = capitulo-49.html;
    });
