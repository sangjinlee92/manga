    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 42; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-41.html;
        document.getElementById('next-chapter').href = capitulo-43.html;
    });
