    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 27; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-26.html;
        document.getElementById('next-chapter').href = capitulo-28.html;
    });
