    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 33; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-32.html;
        document.getElementById('next-chapter').href = capitulo-34.html;
    });
