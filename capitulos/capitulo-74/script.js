    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 74; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-73.html;
        document.getElementById('next-chapter').href = capitulo-75.html;
    });
