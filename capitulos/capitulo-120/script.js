    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 120; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-119.html;
        document.getElementById('next-chapter').href = capitulo-121.html;
    });
