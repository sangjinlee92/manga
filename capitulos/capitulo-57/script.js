    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 57; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-56.html;
        document.getElementById('next-chapter').href = capitulo-58.html;
    });
