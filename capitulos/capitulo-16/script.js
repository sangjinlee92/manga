    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 16; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-15.html;
        document.getElementById('next-chapter').href = capitulo-17.html;
    });
