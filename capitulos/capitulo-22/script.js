    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 22; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-21.html;
        document.getElementById('next-chapter').href = capitulo-23.html;
    });
