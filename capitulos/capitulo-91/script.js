    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentChapter = 91; // Cambia este valor según el capítulo que estés visualizando
        ...
        document.getElementById('previous-chapter').href = capitulo-90.html;
        document.getElementById('next-chapter').href = capitulo-92.html;
    });
